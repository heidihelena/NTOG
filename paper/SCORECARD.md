...
| Calibration **slope 1.15** (apparent/iteration) | CV + optimism-corrected bootstrap (B=500) | CV **0.94**, optimism-corrected **0.83** (0.84 at B=200) | ⚠️ corrected/CV both <1 (mild *over*-confidence) — *opposite direction* to 1.15; report all three |
